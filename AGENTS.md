...
- Replay captured Windows shortcuts only after every physical key in the chord has been released; `SendInput` must not depend on keys that are still physically down.
